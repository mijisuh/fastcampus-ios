...
protocol LEDBoardSettinfDelegate: AnyObject {
    func changedSetting(text: String?, textColor: UIColor, backgroundColor: UIColor) // 데이터 전달 함수
}
...
class SettingViewController: UIViewController {
    ...
    weak var delegate: LEDBoardSettinfDelegate?
